...
void sendToHttp(String base64img) {
  ...
  try {
    ...
    client
        .getUrl(Uri.parse("http://192.168.178.66:5000/"))
        .then((HttpClientRequest request) {
      request.headers.set(
          HttpHeaders.contentTypeHeader, "application/json; charset=UTF-8");
      request.write(
          '{"jsonrpc": "2.0","method": "App.zozomeasure","params": base64img,"id": "1"}');
...
Future<http.Response> createAlbum(String base64img) {
  print("sending....");
  // values for uri.hhtp
  final _authority = "192.168.178.66:5000";
  final _path = "/";
  final _params = {
    //'title': base64str,
    "jsonrpc": "2.0",
    "method": "App.zozomeasure",
    "params": base64img,
    "id": "1"
  };
  ...
  return http.post(
    Uri.parse('https://tkr.myqnapcloud.com/zozo/api?'),
